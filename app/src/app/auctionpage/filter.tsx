...
//                 aria-pressed="false"
//                 type="button"
//                 className={`sc-baf0b6e7-0 sc-baf0b6e7-1 lmdXoa bydNPL sc-4150180c-0  ${selectedButton === "MONTH" ? "vSqNv" : "bKxAGI"}`}
...
//                 aria-pressed="false"
//                 type="button"
//                 className={`sc-baf0b6e7-0 sc-baf0b6e7-1 lmdXoa bydNPL sc-4150180c-0  ${selectedButton === "AUCTION" ? "vSqNv" : "bKxAGI"}`}
...
//         className="sc-2ebfc8f9-0 kCTYtI or eTOBkd"
//       >
//         <div className="sc-2ebfc8f9-2 cgyjAi">
//           <section className="sc-f2a0224c-0 goAIOu sc-8c3cc7b0-1 hgXWxs or jCjrQu">
