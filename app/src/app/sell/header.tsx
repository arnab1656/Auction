...
export const Header = () => {
  return (
    <header className={styles.headerClass}>
      <div className={styles.sc2f7415d9}>
        <div className={styles.kPsJcK}>
          <button className={styles.gNOZtm}>
            <span className="sc-b36ad9cf-0 yhnAg">Open navigation</span>
          </button>
          <div className={styles.Rxlwj}>
            <a className={styles.fOYClD} href="/">
              <svg
                width="200px"
                height="55px"
                viewBox="0 0 100 55"
          ...
          {/* <a className="sc-2f7415d9-7 fAmRtP" href="/search/">
            <svg
              width="42"
              height="42"
              viewBox="0 0 42 42"
          ...
          <nav aria-label="Account" className={styles.btNEZt}>
            <a
              className={styles.kgMmfP}
              href="/register/"
            ...
            <a
              className={styles.kgMmfP}
              href="/login/?next=%2Fauctions%2Fupcoming%2F"
            >
              Log in
            </a>
          </nav>
      ...
      <nav className={styles.YPRqt}>
        <div className={styles.kPsJcK}>
          <div className={styles.cVSSeZ}>
            <a className={styles.fGEmcB} href="/auctions/upcoming/">
              Auctions
            </a>
            <a
              className={styles.kgMmfP}
              href="https://sell.bonhams.com/"
              data-testid="plain-anchor"
            >
              Sell
            </a>
            <a className={styles.kgMmfP} href="/auctions/results/">
              Results
            </a>
            <a className={styles.kgMmfP} href="/department/">
              Departments
            </a>
            <a className={styles.kgMmfP} href="/location/">
              Locations
            </a>
          </div>
          <form
            ...
            role="search"
            action="/search"
            className={styles.jnmJfk}
          >
            <label htmlFor=":R5p8r6:">
              <span className={styles.yhnAg}>Search for a lot</span>
            </label>
            <div className={styles.etxDIi}>
              <input
                autoComplete="off"
                id=":R5p8r6:"
                name="query"
                ...
                type="text"
                className={styles.cjghKl}
              />
              <div className={styles.bDSJEG}>
                <button
                  type="submit"
                  data-testid="search-button"
                  className={styles.krnOzj}
                >
                  <svg
                    width="25"
                    height="25"
