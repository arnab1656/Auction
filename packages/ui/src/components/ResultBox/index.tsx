...
export const ResultBox = ({ filterData, handleDataForResuPage }: any) => {
  console.log("filterData in result box");
  console.log(filterData);

  return (
    <section className="sc-f2a0224c-0 dydMYR sc-8c3cc7b0-11 evdzdn">
      <div className="sc-8c3cc7b0-12 bMwDNR">
          ...
          return (
            <div className="sc-7a302213-0 jXNff">
              <input
                ...
                checked={true}
              />
              <label htmlFor=":r3j:-checkbox" className="sc-7a302213-4 kIfFIU">
        ...
        <button
          className="sc-baf0b6e7-0 sc-baf0b6e7-1 ldcEIf iIdYtS sc-cb679280-0 buYEmA"
          onClick={() => {
            handleDataForResuPage();
          }}
        >
          Clear all filters
        </button>
